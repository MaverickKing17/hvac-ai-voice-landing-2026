...
const PricingCard = ({ tier, price, save, features, highlight = false }: any) => (
  <div className={`glass-card p-10 rounded-[40px] shadow-2xl relative ${highlight ? 'border-2 border-[#FF6B35] scale-105 z-10' : 'z-0 opacity-90'}`}>
     ...
     <button className={`w-full py-4 rounded-xl font-black text-lg transition-all ${highlight ? 'bg-[#FF6B35] text-white hover:bg-[#E55A2B] shadow-lg shadow-[#FF6B35]/30' : 'bg-gray-100 dark:bg-white/10 text-[#003A87] dark:text-white hover:bg-gray-200'}`}>
