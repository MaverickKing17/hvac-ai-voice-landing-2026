      ...
      <div className="container mx-auto px-4 grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-20">
        ...
        <div>
          ...
          <ul className="space-y-4 text-gray-400 font-medium">
            ...
            <li><a href="#" className="hover:text-white transition-colors">Heat Pump Installation</a></li>
            <li><a href="#" className="hover:text-white transition-colors">Tankless Water Heaters</a></li>
          </ul>
        </div>
